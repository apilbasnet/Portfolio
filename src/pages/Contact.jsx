  ...
  return (
    <div className=" flex flex-col  snap-center bg-zinc-900  ">
      <div className="  flex flex-col text-slate-100  py-16 text-2xl max-w-[1140px] m-auto   ">
        ...
        <div className=" flex  flex-col lg:flex-row w-12/12 my-2 px-4 ">
          ...
          <form className="flex flex-col lg:mx-2 lg:w-1/2 ">
            <textarea
        ...
        <div className=" flex flex-row-reverse">
          <button className=" mx-6 bg-slate-50 rounded-none border-none box-border text-gray-900 cursor-pointer inline-block font-bold text-base  m-3 min-h-11 min-w-10 outline-none overflow-hidden px-5 py-2 relative text-center select-none touch-manipulation hover:opacity-75">
            Submit
          </button>
        </div>
      </div>
