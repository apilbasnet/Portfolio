...
export default function About() {
  ...
  return (
    <div className='   flex flex-col mt-20 mb-20'>
      <div className='   min-w-screen   bg-black text-white    w-full    '>
        <div className='flex justify-evenly text-center  py-10  mx-2 lg:max-w-[1140px] lg:mx-auto  font-medium text-xl  '>
