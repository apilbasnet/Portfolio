    ...
    <div >
      ...
      <div className='bg-gradient-to-r  from-blue-500 to-cyan-500  text-white    min-w-screen  flex flex-row  mb-14  '>
        <div className='  flex-row lg:flex md:flex justify-between  items-center  py-10  mx-2 lg:max-w-[1140px] lg:mx-auto  w-[1140px] font-medium text-lg  '>
          ...
          <div>
            <button className=' mx-6 bg-slate-50 rounded-none border-none box-border text-gray-900 cursor-pointer inline-block font-bold text-base  m-3 min-h-11 min-w-10 outline-none overflow-hidden px-10 py-2 relative text-center select-none touch-manipulation hover:opacity-75'>Resume</button>
