    ...
    <div ref={ref} className="workcontainer  md:mx-5 sm:mx-20 ">
      <h1 className="flex  justify-between items-center project-heading  mb-9 max-w-[1140px] m-auto  text-3xl font-bold ">
        ...
        <Link to="https://github.com/apilbasnet" target="blank">
          <button className="bg-gray-900 rounded-none border-none box-border text-white cursor-pointer inline-block font-bold text-base  m-3 min-h-11 min-w-10 outline-none overflow-hidden px-10 py-2 relative text-center select-none touch-manipulation hover:opacity-75">
            {" "}
            Github
          </button>
        </Link>
      ...
      <motion.div
        className=" proj-container max-w-[1140px] m-auto grid grid-cols-1  lg:grid-cols-3   gap-[25px]   text-sm  "
        animate={animation}
      >
        <div className="  lg:col-span-2   flex flex-col overflow-hidden     h-80">
          ...
          <div className=" text-white absolute inset-auto p-10 translate-y-36 lg:max-w-[50%] md:max-w-[70%%] ">
            <h2 className=" font-semibold text-3xl mb-2">{Projects[0].name}</h2>
        ...
        <div className="project-card  flex flex-col      overflow-hidden  h-80">
          ...
          />
          <div className="text-white absolute inset-auto py-10 pl-10 translate-y-36 lg:max-w-[100%] md:max-w-[70%] ">
            <h2 className="font-semibold text-3xl mb-2 ">{Projects[1].name}</h2>
            <p className="mb-2 font-semibold text-xs w-">
        ...
        <div className="project-card  flex flex-col      overflow-hidden     h-80">
          ...
          <div className="text-white absolute inset-auto p-10 translate-y-36 lg:max-w-[25%] md:max-w-[70%] ">
            <h2 className="font-semibold text-3xl mb-2">{Projects[2].name}</h2>
            <p className="mb-2 font-semibold text-xs">
        ...
        <div className=" lg:col-span-2   flex flex-col overflow-hidden     h-80">
          ...
          <div className=" text-white absolute inset-auto p-10 translate-y-36 lg:max-w-[50%] md:max-w-[70%] ">
            <h2 className=" font-semibold text-3xl mb-2">{Projects[3].name}</h2>
            <p className="mb-2 font-semibold text-xs">
